...
class InstagramBot():
    ...
    def put_exactly_like(self, userpost):
        ...
        like_button = '/html/body/div[6]/div[2]/div/article/div/div[2]/div/div/div[2]/section[1]/span[1]/button'
        ...
        with open(f'{file_name}_set.txt') as file:
            ...
            for post_url in urls_list[0:6]:
                try:
                    ...
                    like_button = '/html/body/div[6]/div[2]/div/article/div/div[2]/div/div/div[2]/section[1]/span[' \
                                  '1]/button '
                    browser.find_element_by_xpath(like_button).click()
                    #time.sleep(random.randrange(80, 100))
                    time.sleep(2)
...
my_bot.login()
my_bot.put_many_likes('https://www.instagram.com/baarmee/')